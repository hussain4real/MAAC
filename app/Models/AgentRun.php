 ...
 */
#[Fillable(['agent_id', 'project_id', 'application_id', 'llm_provider_id', 'slug', 'caller', 'status', 'tokens_in', 'tokens_out', 'cost', 'latency_ms', 'tools', 'input', 'error', 'started_at', 'completed_at'])]
