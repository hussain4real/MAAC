...
class StoreSsoConnectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'authorize_url' => ['required', 'url', 'max:2048'],
            'token_url' => ['required', 'url', 'max:2048'],
            'userinfo_url' => ['required', 'url', 'max:2048'],
            ...
            'default_team_role' => ['required', Rule::enum(TeamRole::class)],
